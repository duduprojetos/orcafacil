      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-teal-700 mt-1">Histórico de orçamentos gerados</p>
          </div>
        ...
        <div className="mb-4 relative">
          <input
            ...
            className="w-full border border-emerald-300 rounded-lg px-4 py-3 pr-10 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
          />
          {busca && (
            <button
              onClick={() => setBusca("")}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-emerald-500 hover:text-emerald-800 text-xl"
            >
              ✕
            </button>
          )}
        ...
        {carregando && (
          <div className="app-card p-8 text-center text-teal-700">
            Carregando...
          </div>
        )}
        ...
        {!carregando && orcamentos.length === 0 && (
          <div className="app-card p-8 text-center text-teal-700">
            ...
            <Link href="/app" className="inline-block bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div className="flex-1 w-full">
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        <span className="text-xs text-emerald-500">{formatarData(orc.created_at)}</span>
                        ...
                        <div className="relative">
                          ...
                          {menuAbertoId === orc.id && (
                            <div className="absolute top-full mt-1 left-0 bg-white rounded-lg shadow-xl border border-emerald-200 py-1 z-10 min-w-[140px]">
                              <button
                      ...
                      <p className="text-lg font-semibold text-emerald-900">{orc.cliente}</p>
                      <p className="text-sm text-teal-700">De: {orc.empresa}</p>
                    </div>

                    <div className="text-right md:mr-4">
                      <p className="text-2xl font-bold text-emerald-950">R$ {Number(orc.total).toFixed(2)}</p>
                    ...
                    <div className="flex gap-2 w-full md:w-auto flex-wrap">
                      ...
                      <button
                        ...
                        className="flex-1 md:flex-none text-emerald-800 hover:text-white hover:bg-emerald-600 border border-emerald-600 text-sm font-medium px-4 py-2 rounded-lg transition-colors"
                      >
                        ✏️ Editar
                      </button>
                      <button
